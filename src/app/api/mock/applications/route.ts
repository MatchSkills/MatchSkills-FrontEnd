...
let mockApplications: Application[] = [
  {
    ...
    status: 'completed',
    telegramLink: 'https://t.me/MatchSkillsEvaluationBot?start=app_1',
    softSkillScore: 92,
    hardSkillScore: 88,
    averageScore: 90,
  ...
  },
  {
    ...
    status: 'completed',
    telegramLink: 'https://t.me/MatchSkillsEvaluationBot?start=app_2',
    softSkillScore: 78,
    hardSkillScore: 95,
    averageScore: 86.5,
  ...
  },
  {
    ...
    status: 'evaluating',
    telegramLink: 'https://t.me/MatchSkillsEvaluationBot?start=app_3',
    softSkillScore: 65,
    hardSkillScore: 58,
    averageScore: 61.5,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const telegramLink = `https://t.me/MatchSkillsEvaluationBot?start=${newAppId}`;
